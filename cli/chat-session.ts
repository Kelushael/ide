...
import { OllamaClient, OllamaMessage } from './ollama-client.js';
...
export class ChatSession {
  ...
  private async chatLoop() {
    ...
    rl.on('line', async (line: string) => {
      ...
      // Add user message
      const userMessage: OllamaMessage = { role: 'user', content: line };
      ...
      try {
        ...
        const assistantMessage: OllamaMessage = { role: 'assistant', content: fullResponse };
